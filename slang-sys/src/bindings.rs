...
pub enum SlangCompileTarget {
    ...
    #[doc = "< A CPU target that makes the compiled shader code\n< available to be run immediately"]
    ...
    CudaObjectCode = 19,
    #[doc = "< Object code that can be used for later linking (kernel/shader)"]
    ObjectCode = 20,
    ...
    HostVm = 31,
    #[doc = "< C++ header for shader kernels."]
    CppHeader = 32,
    #[doc = "< Cuda header"]
    CudaHeader = 33,
    #[doc = "< Host object code"]
    HostObjectCode = 34,
    #[doc = "< Host LLVM IR assembly"]
    HostLlvmIr = 35,
    #[doc = "< Host LLVM IR assembly (kernel/shader)"]
    ShaderLlvmIr = 36,
    TargetCountOf = 37,
}
...
pub enum SlangPassThrough {
    ...
    Gcc = 7,
    #[doc = "< Generic C or C++ compiler, which is decided by\n< the source type"]
    GenericCCpp = 8,
...
pub enum SlangLineDirectiveMode {
    ...
    Standard = 2,
    #[doc = "< Emit GLSL-style directives with file *number*\ninstead of name"]
    Glsl = 3,
    #[doc = "< Use a source map to track line mappings (ie\nno #line will appear in emitting source)"]
    SourceMap = 4,
}
...
pub type SlangScopeIntegral = SlangUInt32;
#[repr(u32)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum SlangScope {
...
pub type SlangCooperativeMatrixUseIntegral = SlangUInt32;
#[repr(u32)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum SlangCooperativeMatrixUse {
    A = 0,
    B = 1,
    Accumulator = 2,
}
...
pub enum SlangDebugInfoFormat {
    ...
    Default = 0,
    #[doc = "< CodeView C7 format (typically means debugging\n< information is embedded in the binary)"]
    C7 = 1,
    ...
    #[doc = "< COFF debug info"]
    Coff = 4,
    #[doc = "< DWARF debug info (we may want to support specifying\n< the version)"]
    Dwarf = 5,
    CountOf = 6,
}
...
pub enum SlangOptimizationLevel {
    ...
    None = 0,
    #[doc = "< Default optimization level: balance code quality\nand compilation time."]
    Default = 1,
    #[doc = "< Optimize aggressively."]
    High = 2,
    #[doc = "< Include optimizations that may take a very long\ntime, or may involve severe space-vs-speed\ntradeoffs"]
    Maximal = 3,
}
#[repr(i32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct slang_SourceLocation {
...
unsafe extern "C" {
    pub fn slang_writeCoverageManifestJson(
        metadata: *mut slang_ICoverageTracingMetadata,
        outBlob: *mut *mut ISlangBlob,
    ) -> SlangResult;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn slang_enableRecordLayer(enable: bool);
}
unsafe extern "C" {
    pub fn slang_isRecordLayerEnabled() -> bool;
}
unsafe extern "C" {
    pub fn slang_setReplayDirectory(path: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn slang_getReplayDirectory() -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn slang_getCurrentReplayPath() -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn slang_loadReplay(folderPath: *const ::std::os::raw::c_char) -> SlangResult;
}
unsafe extern "C" {
    pub fn slang_loadLatestReplay() -> SlangResult;
}
unsafe extern "C" {
    pub fn slang_replayMarker(label: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
